document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizQuestions = [
        ...
        { questionText: "Parmi les options suivantes, laquelle est une bibliothèque JavaScript populaire pour construire des interfaces utilisateur, souvent utilisée comme base pour des frameworks Front-end ?", options: ["jQuery", "React", "AngularJS", "MooTools"], correctAnswerIndex: 1, type: 'technical' },
